                ...
                <tr class="bg-white">
                    ...
                    <td class="px-6 py-4 text-sm leading-5 text-center text-gray-900 whitespace-no-wrap">
                        <router-link :to="{ name: 'products.edit', params: { id: item.id } }"
                                     class="px-4 py-2 rounded-md text-blue border border-transparent bg-indigo-600 cursor-pointer hover:bg-indigo-700">
                            Edit
                        </router-link>
...
const {products, getProducts, destroyProduct, pagination} = useProducts()
